...
Certificate verification is deliberately disabled for the fixed campus endpoint. Scoped trust-manager lint suppressions document this choice. English-only text and legacy API 23 compatibility warnings remain.
