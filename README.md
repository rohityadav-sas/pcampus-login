...
Try **Root** first if your phone is rooted; otherwise start with **Permanent Notification**.
Next try **Legacy (Android 6-14)**, or **Modern** if you need a newer target without a permanent notification.
Modern remains best-effort when Android kills/freezes its process.

See [the APK comparison and setup guide](docs/DOWNLOADS.md)
